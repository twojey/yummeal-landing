...
import { articles, getArticle } from '../data/sante';
...
export default function SanteArticlePage() {
  ...
  if (!article) {
    return <Navigate to="/sante" replace />;
  }
    ...
    <div className="min-h-screen bg-[#FFFAF0] px-4 md:px-8 pt-24 pb-16">
      <div className="max-w-3xl mx-auto">
        <nav className="text-sm text-gray-500 mb-4">
          <Link to="/sante" className="text-[#FF8C42] hover:underline">
            Santé & alimentation
          </Link>
        </nav>
        ...
        <SiloSiblings
          ...
          heading="Les autres guides santé et alimentation"
