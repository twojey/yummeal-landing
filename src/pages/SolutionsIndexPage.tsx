...
import { articles } from '../data/solutions';
import DownloadButtons from '../components/DownloadButtons';

export default function SolutionsIndexPage() {
  usePageMeta({
    title: 'Solutions cuisine du quotidien | Yummeal',
    description:
      "Charge mentale des repas, petit budget, cuisine sans four, rééquilibrage alimentaire : nos guides pratiques pour des problèmes du quotidien.",
    ...
    <div className="min-h-screen bg-[#FFFAF0] px-4 md:px-8 pt-24 pb-16">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold leading-tight text-center mb-4">
          Solutions cuisine du quotidien
        </h1>
        <p className="text-lg text-gray-700 text-center max-w-2xl mx-auto mb-12">
          Charge mentale, petit budget, cuisine sans équipement, envie de
          mieux manger : nos guides pratiques pour avancer sur des situations
          concrètes, sans jargon ni promesse creuse.
        </p>
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">
            Envie de ne plus vous poser la question à chaque repas ?
          </h2>
