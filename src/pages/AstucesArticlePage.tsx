...
import { articles, getArticle } from '../data/astuces';
...
export default function AstucesArticlePage() {
  ...
  if (!article) {
    return <Navigate to="/astuces" replace />;
  }
    ...
    <div className="min-h-screen bg-[#FFFAF0] px-4 md:px-8 pt-24 pb-16">
      <div className="max-w-3xl mx-auto">
        <nav className="text-sm text-gray-500 mb-4">
          <Link to="/astuces" className="text-[#FF8C42] hover:underline">
            Astuces
          </Link>
        </nav>
