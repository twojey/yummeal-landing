...
import { articles } from '../data/sante';
import DownloadButtons from '../components/DownloadButtons';

export default function SanteIndexPage() {
  usePageMeta({
    title: 'Santé & alimentation | Sécurité alimentaire et nutrition - Yummeal',
    description:
      "Conservation des aliments, sécurité alimentaire, repères nutritionnels généraux : nos guides pour cuisiner et manger l'esprit tranquille.",
    canonicalPath: '/sante',
  });
    ...
    <div className="min-h-screen bg-[#FFFAF0] px-4 md:px-8 pt-24 pb-16">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-lg text-gray-700 text-center max-w-2xl mx-auto mb-12">
          Des repères généraux sur la conservation des aliments et la
          nutrition, pour cuisiner sereinement. Ces informations ne
          remplacent pas un avis médical personnalisé.
        </p>
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">
            Envie de cuisiner plus sereinement au quotidien ?
          </h2>
